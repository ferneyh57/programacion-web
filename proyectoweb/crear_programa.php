      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Vendedores</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="Tabla_vend_creados.html"><i class="icon fa fa-circle-o"></i> Tabla vend. creados</a></li>
          </ul>
        </li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="row">
              <div class="col-lg-6">
                <form method="POST" action="crearprograma.php">
                 <div class="form-group">
                    <label class="col-form-label" >Nombre del Programa</label>
                    <input class="form-control" id="inputdocumento" name="programa" type="text">
                  </div>
                  
                <div class="tile-footer">
                  <button class="btn btn-primary" name="enviar" type="submit">Crear Programa.</button>
                </div>
                </form>
              </div>
            </div>
