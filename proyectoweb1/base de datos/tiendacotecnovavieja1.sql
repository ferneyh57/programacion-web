...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-10-2019 a las 18:57:09
...
--
ALTER TABLE `estudiantes`
  MODIFY `est_id` int(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Numero de identificacion del estudiante', AUTO_INCREMENT=17;
