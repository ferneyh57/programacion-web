...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-10-2019 a las 18:48:56
...
(4, 1, '1', '1', 1, '1', 0, 1, 1),
(13, 191919, 'camilo', 'lopera', 1111, '4d186321c1a7f0f354b297e8914ab240', 3, 3, 3),
(14, 1192713025, 'ferney', 'Hurtado', 1000, '1c7a92ae351d4e21ebdfb897508f59d6', 2, 2, 2);
...
--
ALTER TABLE `estudiantes`
  MODIFY `est_id` int(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Numero de identificacion del estudiante',AUTO_INCREMENT=15;
--
